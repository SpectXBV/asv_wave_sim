...
#include "JonswapFFTWaveSimulationImpl.hh"
...
{
//////////////////////////////////////////////////
JonswapFFTWaveSimulation::Impl::~Impl()
{
  DestroyFFTWPlans();
}
...
//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::Impl::SetLambda(double value)
{
  lambda_ = value;
  ComputeBaseAmplitudes();
}
...
//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::Impl::SetHs(double value)
{
  hs_ = value;
  ComputeBaseAmplitudes();
}
...
//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::Impl::SetTp(double value)
{
  tp_ = value;
  ComputeBaseAmplitudes();
}
...
//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::Impl::SetGamma(double value)
{
  gamma_ = value;
  ComputeBaseAmplitudes();
}
...
//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::Impl::SetWaveDirectionDeg(double value)
{
  phi_wave_ = M_PI / 180.0 * value;
  ComputeBaseAmplitudes();
}

//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::Impl::SetDirectionalSpread(double value)
{
  s_param_ = value;
  ComputeBaseAmplitudes();
}
...
//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::Impl::SetSteepness(double value)
{
  lambda_ = value;
}

//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::Impl::SetTime(double time)
{
  ComputeCurrentAmplitudes(time);
}

//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::Impl::ElevationAt(
...
//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::Impl::ElevationDerivAt(
...
//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::Impl::DisplacementAt(
...
//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::Impl::DisplacementDerivAt(
...
//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::Impl::PressureAt(
    Index iz,
...
//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::Impl::ComputeBaseAmplitudes()
{
  InitWaveNumbers();
  InitPressureGrid();
  ...
  // JONSWAP omnidirectional spectrum, parameterised directly by Hs/Tp/gamma
  // (independent of wind), combined with the existing cosine-2S directional
  // spreading function centred on an independently settable dominant wave
  // direction.
  gz::waves::JonswapWaveSpectrum spectrum;
  spectrum.SetGravity(gravity_);
  spectrum.SetHs(hs_);
  spectrum.SetTp(tp_);
  spectrum.SetGamma(gamma_);

  gz::waves::Cos2sSpreadingFunction spreadingFn;
  spreadingFn.SetSpread(s_param_);
  ...
  for (Index ikx = 0; ikx < nx_; ++ikx)
  {
    ...
    for (Index iky = 0; iky < ny_; ++iky)
    {
      ...
      double cap_psi = spreadingFn.Evaluate(phi, phi_wave_, k);
...
//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::Impl::ComputeCurrentAmplitudes(
    double time)
{
  // set all true
  std::transform(
...
//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::Impl::InitWaveNumbers()
{
...
//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::Impl::InitPressureGrid()
{
...
//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::Impl::CreateFFTWPlans()
{
...
//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::Impl::DestroyFFTWPlans()
{
...
//////////////////////////////////////////////////
//////////////////////////////////////////////////
JonswapFFTWaveSimulation::~JonswapFFTWaveSimulation()
{
}
...
JonswapFFTWaveSimulation::JonswapFFTWaveSimulation(
    double lx, double ly, Index nx, Index ny) :
  impl_(new JonswapFFTWaveSimulation::Impl(lx, ly, nx, ny))
{
}
...
JonswapFFTWaveSimulation::JonswapFFTWaveSimulation(
    double lx, double ly, double lz, Index nx, Index ny, Index nz) :
  impl_(new JonswapFFTWaveSimulation::Impl(lx, ly, lz, nx, ny, nz))
{
}

//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::SetLambda(double value)
{
  impl_->SetLambda(value);
}

//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::SetHs(double value)
{
  impl_->SetHs(value);
}

//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::SetTp(double value)
{
  impl_->SetTp(value);
}

//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::SetGamma(double value)
{
  impl_->SetGamma(value);
}

//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::SetWaveDirectionDeg(double value)
{
  impl_->SetWaveDirectionDeg(value);
}

//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::SetDirectionalSpread(double value)
{
  impl_->SetDirectionalSpread(value);
}

//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::SetWindVelocity(double /*ux*/, double /*uy*/)
{
  // Not used by the JONSWAP spectrum - present only to satisfy the
  // IWaveSimulation interface. Use SetWaveDirectionDeg to control the
  // dominant wave direction instead.
}

//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::SetSteepness(double value)
{
  impl_->SetSteepness(value);
}

//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::SetTime(double value)
{
  impl_->SetTime(value);
}

//////////////////////////////////////////////////
Index JonswapFFTWaveSimulation::SizeX() const
{
  return impl_->nx_;
}

//////////////////////////////////////////////////
Index JonswapFFTWaveSimulation::SizeY() const
{
  return impl_->ny_;
}

//////////////////////////////////////////////////
Index JonswapFFTWaveSimulation::SizeZ() const
{
  return impl_->nz_;
}

//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::ElevationAt(
...
//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::ElevationDerivAt(
    Eigen::Ref<Eigen::ArrayXXd> dhdx,
...
//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::DisplacementAt(
    Eigen::Ref<Eigen::ArrayXXd> sx,
...
//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::DisplacementDerivAt(
    Eigen::Ref<Eigen::ArrayXXd> dsxdx,
    Eigen::Ref<Eigen::ArrayXXd> dsydy,
...
//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::DisplacementAndDerivAt(
    Eigen::Ref<Eigen::ArrayXXd> h,
    Eigen::Ref<Eigen::ArrayXXd> sx,
    Eigen::Ref<Eigen::ArrayXXd> sy,
    Eigen::Ref<Eigen::ArrayXXd> dhdx,
...
//////////////////////////////////////////////////
void JonswapFFTWaveSimulation::PressureAt(
    Index iz,
