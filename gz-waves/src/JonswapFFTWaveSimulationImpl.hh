...
#ifndef GZ_WAVES_SRC_JONSWAPFFTWAVESIMULATIONIMPL_HH_
#define GZ_WAVES_SRC_JONSWAPFFTWAVESIMULATIONIMPL_HH_
...
{
//////////////////////////////////////////////////
// JonswapFFTWaveSimulation::Impl
//
// Adapted from LinearRandomFFTWaveSimulationImpl.hh: identical FFT
// machinery, but the base amplitudes are built from a JonswapWaveSpectrum
// and a Cos2sSpreadingFunction centred on an independent dominant wave
// direction instead of ECKVWaveSpectrum driven by wind.

typedef double fftw_data_type;
typedef std::complex<fftw_data_type> complex;

class JonswapFFTWaveSimulation::Impl
{
 public:
  ...
  /// \brief Significant wave height [m]
  double  hs_{2.0};

  /// \brief Peak period [s]
  double  tp_{8.0};

  /// \brief JONSWAP peak-enhancement factor
  double  gamma_{3.3};

  /// \brief Dominant wave direction. Counter clockwise angle from x-axis
  ///        [rad]. Independent of wind.
  double  phi_wave_{0.0};
...
#endif  // GZ_WAVES_SRC_JONSWAPFFTWAVESIMULATIONIMPL_HH_
